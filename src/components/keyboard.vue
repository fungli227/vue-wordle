...
<template>
    <div class="row flex mb-[2px] justify-center" v-for="row in rows">
        <a href="#" class="key p-3 m-[2px] rounded-sm flex content-center uppercase items-center text-white select-none active:bg-teal-500" 
             :class="getColor(key)" v-for="key in row" @click.prevent="click(key)">
